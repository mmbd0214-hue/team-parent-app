...
window.openEvent=()=>{$("adminEventForm").reset();$("editEventId").value="";$("eventDialogTitle").textContent="建立活動 / 比賽";$("eventStatusLabel").classList.add("hidden");$("eventMealInput").value=100;$("eventMeetTimeInput").value="";$("eventMeetTimeInput").disabled=false;$("eventMeetTimeTbdInput").checked=false;$("matchRows").innerHTML="";addMatchRow();renderEventPlayers([]);eventDialog.showModal()};
